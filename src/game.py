...
class Game:
    ...
    def make_move(self, direction: Direction) -> Tuple[int, bool]:
        ...
        move_score = self.__move_tiles(direction)
    ...
    def __move_tiles(self, direction: Direction) -> int:
        ...
        Returns:
            int: Score generated by the move.
        """
        ...
        for merge_index in range(len(to_combine)):
            ...
            combined_tiles, merge_score = self.__combine_tiles(
    ...
    def __combine_tiles(self, tiles: List[int], right: bool) -> Tuple[List[int], int]:
        ...
        Returns:
            Tuple[List[int], int]: List of tiles after combining and the score generated.
        """
